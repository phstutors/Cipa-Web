    ...
    <div class="agroup">
      <div class="row">
        ...
        <div class="row">
          ...
          <textarea id="descricao" v-model="descricao" v-bind:class="{'error' : descricao.length < 50 || descricao.length > 500}" minlength="200" :disabled="descricao.length > 10" maxlength="800" name="descrendoProjeto" placeholder="Descreva seu Projeto (Minimo 200 Caracteres / Maximo 500 Caracter)" required></textarea>
        </div>
        </div>
         <div class="row2">
        ...
        <i class="material-icons right">send</i>
                ...
                <div class="has-login"> 
      <p>Quer dicas? <a v-on:click="entre()">Clique Aqui.</a></p>
    </div>
